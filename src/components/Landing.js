...
const Landing = () => {
    ...
    return (
        <div className='flex-col h-screen flex justify-center '>Landing
            <div className="mx-10">
            ...
            <div className="flex justify-center w-screen border-4 mt-24">
                <div className="flex border-4 m-auto">
                    <Link href={"./market"}>
                        <button className="rounded-3xl border-black bg-black text-gray-50 border-4 p-1" > Get Started</button>
                    </Link>
                </div>
                <div className="flex flex-col border-4 m-auto p-4">
